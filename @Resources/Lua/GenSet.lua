...
function Initialize()
	...
	,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 1 ? 220 : 0)\n'
	,'Handle=1\n'
	...
	,'Y=(10*[Set.S])R\n'
	,'MeterStyle=PageBox:S\n'
	,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 2 ? 220 : 0)\n'
	,'Handle=2\n'
	...
	if string.find(Appearance, Skin) then
		...
		,'Y=(10*[Set.S])R\n'
		,'MeterStyle=PageBox:S\n'
		,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 3 ? 220 : 0)\n'
		,'Handle=3\n'
	...
	if string.find(Layout, Skin) then
		...
		,'Y=(10*[Set.S])R\n'
		,'MeterStyle=PageBox:S\n'
		,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 4 ? 220 : 0)\n'
		,'Handle=4\n'
	...
	if string.find(Media, Skin) then
		...
		,'Y=(10*[Set.S])R\n'
		,'MeterStyle=PageBox:S\n'
		,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 5 ? 220 : 0)\n'
		,'Handle=5\n'
	...
	if string.find(Render, Skin) then
		...
		,'Y=(10*[Set.S])R\n'
		,'MeterStyle=PageBox:S\n'
		,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 6 ? 220 : 0)\n'
		,'Handle=6\n'
	...
	if string.find(FAQ, Skin) then
		...
		,'Y=(10*[Set.S])R\n'
		,'MeterStyle=PageBox:S\n'
		,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = 12 ? 220 : 0)\n'
		,'Handle=12\n'
	...
	-- 	,'Y=(10*[Set.S])R\n'
	-- 	,'MeterStyle=PageBox:S\n'
	-- 	,'Fill=Fill Color #Set.Text_Color#,(#BarHandler# = <> ? 220 : 0)\n'
	-- 	,'Handle=<\n'
	-- 	
	-- 	,'\n'
	-- 	,'[{}Icon]\n'
