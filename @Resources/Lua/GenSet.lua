...
function Initialize()
	...
	-- 	,'Y=(10*#Set.S#)R\n'
	-- 	,'MeterStyle=PageBox:S\n'
	-- 	,'Fill=Fill Color #Set.Opp_Color#,(#BarHandler# = <> ? 220 : 0)\n'
	-- 	,'MouseOverAction=[!SetOption #CURRENTSECTION# Fill "Fill Color #Set.Opp_Color#,(#BarHandler# = <> ? 220 : 100)"][!UpdateMeter #CURRENTSECTION#][!Redraw]\n'
	-- 	,'MouseLeaveAction=[!SetOption #CURRENTSECTION# Fill "Fill Color #Set.Opp_Color#,(#BarHandler# = <> ? 220 : 0)"][!UpdateMeter #CURRENTSECTION#][!Redraw]\n'
	-- 	,'\n'
	-- 	,'[{}Icon]\n'
	-- 	,'Meter=Image\n'
	-- 	,'MeterStyle=PageIcon:S\n'
